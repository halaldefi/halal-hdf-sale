...
export function HowToBuy({ openItems }: { openItems: string[] }) {
  ...
  const handleVideoClick = () => {
    ...
    if (window.innerWidth <= 768) {
      ...
      window.open("https://www.loom.com/share/f49f5be56d2d4b4a84f8792996ccec50", "_blank");
    } else {
        ...
        <div className="space-y-6">
          <div>
            ...
            <Dialog open={isVideoDialogOpen} onOpenChange={setIsVideoDialogOpen}>
              <DialogContent
                className="fixed left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%] max-w-[95vw] w-full md:max-w-[92vw] lg:max-w-[1600px] bg-transparent border-0 p-6"
                style={{
                  position: 'fixed',
                  top: '50%',
                  left: '50%',
