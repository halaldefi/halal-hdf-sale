  ...
  return (
    <Card className="bg-[#fff9ec] p-4 sm:p-6 space-y-4 w-full max-w-[475px] mx-auto 
      ...
      <div className="relative flex flex-col gap-3">
        {/* Sell Section */}
        <div 
          className="group bg-white p-4 sm:p-5 rounded-xl border border-[#E8C375]/20 
            shadow-md will-change-transform
            transition-all duration-300 ease-soft
            hover:shadow-lg hover:border-[#E8C375]/30 cursor-pointer
        ...
        >
          <div className="flex items-center justify-between">
            <div className="flex flex-col items-start">
              ...
              <input
                ...
                className="text-3xl sm:text-4xl font-medium bg-transparent outline-none w-40 mt-2
                  ...
                  focus:text-[#D18411] group-hover:text-[#D18411]/90"
              />
            ...
            <div className="flex items-center px-4 py-2.5 bg-white rounded-xl border border-[#E8C375]/20 
              ...
              transition-all duration-300 ease-soft
              hover:shadow-md hover:bg-gray-50/80 hover:-translate-y-0.5
              active:translate-y-0 active:shadow-sm">
              <div className="flex items-center justify-center h-8 w-8 relative -ml-2">
                <div className="absolute top-[1px] left-[1px] w-[30px] h-[30px] bg-[#FFFFFF35] rounded-full
                  transition-transform duration-300 ease-bounce group-hover:scale-110"></div>
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"
                  className="transition-transform duration-300 ease-bounce group-hover:scale-105">
        ...
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-10">
          <div
            className="flex items-center justify-center bg-white border-4 border-[#fff9ec] rounded-xl p-2.5
              ...
              hover:shadow-lg hover:scale-110 hover:border-[#E8C375]/20"
          >
            <svg
              viewBox="0 0 24 24"
              fill="none"
              strokeWidth="2.5"
              className="w-6 h-6 text-[#D18411] transition-colors duration-300 ease-soft"
            >
        ...
        {/* Buy Section */}
        <div 
          className="group bg-gray-50 p-4 sm:p-5 rounded-xl border border-[#E8C375]/20 
            shadow-md will-change-transform
            transition-all duration-300 ease-soft
            hover:shadow-lg hover:border-[#E8C375]/30 cursor-pointer
            transform hover:-translate-y-1"
            ...
            <div className="flex items-center px-4 py-2.5 bg-white rounded-xl border border-[#E8C375]/20 
              ...
              <div className="flex items-center justify-center h-8 w-8 relative -ml-2">
                ...
                <Image
                  ...
                  width={32}
                  height={32}
                  className="rounded-full object-contain transition-transform duration-300 ease-bounce group-hover:scale-105"
                />
              </div>
      ...
      <button 
        className="w-full text-white py-3 sm:py-4 rounded-xl font-semibold text-lg sm:text-xl
          ...
          active:shadow-inner active:translate-y-0 active:scale-[0.99]
          mt-6"
      >
        BUY
      </button>
