  ...
  return (
    <Card className="bg-[#F5F3EF] p-3 sm:p-3 space-y-1 w-full max-w-[475px] mx-auto shadow-lg rounded-xl">
      ...
      <div className="relative flex flex-col gap-1">
        {/* Sell Section */}
        <div className="bg-white p-3 sm:p-4 rounded-lg border-[0.5px] border-[#E6E6F2] pb-2">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center px-4 py-2 bg-white rounded-full border border-[#f2f2f2] shadow-[0_0_10px_rgba(34,34,34,0.04)]">
              ...
              <span className="font-medium text-[#222222] ml-2">USDT</span>
            </div>
          </div>
        </div>
        {/* Down Arrow */}
        ...
        {/* Buy Section */}
        <div className="bg-[#f5f5f5] p-3 sm:p-4 rounded-lg border-[0.5px] border-[#E6E6F2] pt-2">
          <div className="flex items-center justify-between">
            <div>
            ...
            <div className="flex items-center px-4 py-2 bg-white rounded-full border border-[#f2f2f2] shadow-[0_0_10px_rgba(34,34,34,0.04)]">
              ...
              <span className="font-medium text-[#222222] ml-2">HDF</span>
            </div>
          </div>
        </div>
      </div>
